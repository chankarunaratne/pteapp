...
export default function WeScoreOverview({
  score,
  lang = "si",
}: {
  score: WeScoreResult;
      ...
      <div className="flex items-center gap-5">
        ...
        <div>
          ...
          >
            {pct >= 70
              ? lang === "si"
                ? "හොඳ රචනාවක්! ප්‍රධාන කරුණු ආවරණය කර ඇත."
                : "Great essay! Key points are well covered."
              : pct >= 40
                ? lang === "si"
                  ? "සාමාන්‍ය මට්ටමක්. ව්‍යුහය සහ අන්තර්ගතය වැඩිදියුණු කරන්න."
                  : "Reasonable attempt. Improve structure and content."
                : lang === "si"
