    ...
    <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center border-b border-slate-200/70 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6">
        ...
        <div ref={dropdownRef} className="relative">
          ...
          {/* Dropdown menu */}
          {settingsOpen && (
            <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-xl border border-slate-200/80 bg-white p-2 shadow-lg shadow-slate-200/50 ring-1 ring-black/5">
