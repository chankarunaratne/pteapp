import type { HcsQuestion } from "./questions";

/* ------------------------------------------------------------------ */
/*  Types                                                              */
/* ------------------------------------------------------------------ */

export interface HcsOptionFeedback {
  option: string;
  index: number;
  isSelected: boolean;
  isCorrect: boolean;
...
export interface HcsScoreResult {
  optionFeedbacks: HcsOptionFeedback[];
 ...
 */
export function scoreHcsAnswer(
  question: HcsQuestion,
  selectedIndex: number | null
): HcsScoreResult {
  const optionFeedbacks: HcsOptionFeedback[] = question.options.map((option, index) => {
    const isSelected = selectedIndex === index;
    const isCorrect = question.correctIndex === index;

    let status: HcsOptionFeedback["status"];
    if (isSelected) {
